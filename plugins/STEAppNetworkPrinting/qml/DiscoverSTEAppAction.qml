            ...
            Column
            {
                ...
                Grid
                {
                    ...
                    Label
                    {
                        width: Math.round(parent.width * 0.5)
                        wrapMode: Text.WordWrap
                        text: catalog.i18nc("@label", "Model")
                    }
                    Label
                    {
                        width: Math.round(parent.width * 0.5)
                        wrapMode: Text.WordWrap
                        text: base.selectedDevice ? base.selectedDevice.model : ""
                    }
                    Label
                    {
                        width: Math.round(parent.width * 0.5)
                        wrapMode: Text.WordWrap
                        text: catalog.i18nc("@label", "Printers")
                    }
                    Label
                    {
                        width: Math.round(parent.width * 0.5)
                        wrapMode: Text.WordWrap
                        text: base.selectedDevice ? base.selectedDevice.printers : ""
                    }
                    Label
                    {
                        width: Math.round(parent.width * 0.5)
