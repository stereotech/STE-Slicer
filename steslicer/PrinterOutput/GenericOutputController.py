...
if TYPE_CHECKING:
    ...
    from steslicer.PrinterOutput.PrinterOutputDevice import PrinterOutputDevice
    from steslicer.PrinterOutput.ExtruderOutputModel import ExtruderOutputModel
