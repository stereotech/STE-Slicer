...
from steslicer.Scene.ConvexHullDecorator import ConvexHullDecorator
...
from steslicer.Machines.Models.NozzleModel import NozzleModel
from steslicer.Machines.Models.QualityProfilesDropDownMenuModel import QualityProfilesDropDownMenuModel
from steslicer.Machines.Models.CustomQualityProfilesDropDownMenuModel import CustomQualityProfilesDropDownMenuModel
from steslicer.Machines.Models.MultiBuildPlateModel import MultiBuildPlateModel
from steslicer.Machines.Models.FavoriteMaterialsModel import FavoriteMaterialsModel
from steslicer.Machines.Models.GenericMaterialsModel import GenericMaterialsModel
from steslicer.Machines.Models.MaterialBrandsModel import MaterialBrandsModel
from steslicer.Machines.Models.QualityManagementModel import QualityManagementModel
from steslicer.Machines.Models.QualitySettingsModel import QualitySettingsModel
from steslicer.Machines.Models.MachineManagementModel import MachineManagementModel
...
from steslicer.Settings.SettingInheritanceManager import SettingInheritanceManager
...
from steslicer.PrinterOutput.NetworkMJPGImage import NetworkMJPGImage
...
class SteSlicerApplication(QtApplication):
    ...
    def __addExpectedResourceDirsAndSearchPaths(self):
        # this list of dir names will be used by UM to detect an old steslicer directory
        for dir_name in ["extruders", "machine_instances", "materials", "plugins", "quality", "quality_changes", "user", "variants"]:
            Resources.addExpectedDirNameInData(dir_name)

        Resources.addSearchPath(os.path.join(self._app_install_dir, "share", "steslicer", "resources"))
        ...
        self._version_upgrade_manager.setCurrentVersions(
            {
                ...
                ("machine_stack", ContainerStack.Version * 1000000 + self.SettingVersion):         (self.ResourceTypes.MachineStack, "application/x-steslicer-globalstack"),
                ("extruder_train", ContainerStack.Version * 1000000 + self.SettingVersion):        (self.ResourceTypes.ExtruderStack, "application/x-steslicer-extruderstack"),
    ...
    def startSplashWindowPhase(self) -> None:
        ...
        self.setWindowIcon(QIcon(Resources.getPath(Resources.Images, "steslicer-icon.png")))
        ...
        self._i18n_catalog = i18nCatalog("steslicer")
        ...
        preferences.addPreference("steslicer/active_mode", "simple")

        preferences.addPreference("steslicer/categories_expanded", "")
        preferences.addPreference("steslicer/jobname_prefix", True)
        preferences.addPreference("steslicer/select_models_on_load", False)
        preferences.addPreference("view/center_on_select", False)
        preferences.addPreference("mesh/scale_to_fit", False)
        preferences.addPreference("mesh/scale_tiny_meshes", True)
        preferences.addPreference("steslicer/dialog_on_project_save", True)
        preferences.addPreference("steslicer/asked_dialog_on_project_save", False)
        preferences.addPreference("steslicer/choice_on_profile_override", "always_ask")
        preferences.addPreference("steslicer/choice_on_open_project", "always_ask")
        preferences.addPreference("steslicer/use_multi_build_plate", False)

        preferences.addPreference("steslicer/currency", "₽")
        preferences.addPreference("steslicer/material_settings", "{}")

        preferences.addPreference("view/invert_zoom", False)
        preferences.addPreference("view/filter_current_build_plate", False)
        preferences.addPreference("steslicer/sidebar_collapsed", False)

        preferences.addPreference("steslicer/favorite_materials", "")
    ...
    def discardOrKeepProfileChanges(self) -> bool:
        ...
        choice = self.getPreferences().getValue("steslicer/choice_on_profile_override")
    ...
    def _loadPlugins(self):
        ...
        for suffix in lib_suffixes:
            self._plugin_registry.addPluginLocation(os.path.join(QtApplication.getInstallPrefix(), "lib" + suffix, "steslicer"))
        if not hasattr(sys, "frozen"):
    ...
    def getSceneBoundingBox(self):
        return self._scene_bounding_box
    ...
    def setExpandedCategories(self, categories):
        ...
        if joined != self.getPreferences().getValue("steslicer/categories_expanded"):
            self.getPreferences().setValue("steslicer/categories_expanded", joined)
    ...
    def expandedCategories(self):
        return self.getPreferences().getValue("steslicer/categories_expanded").split(";")
    ...
    def readLocalFile(self, file, skip_project_file_check = False):
        ...
        if self.getPreferences().getValue("steslicer/select_models_on_load"):
            Selection.clear()
    ...
    def _readMeshFinished(self, job):
        ...
        select_models_on_load = self.getPreferences().getValue("steslicer/select_models_on_load")
