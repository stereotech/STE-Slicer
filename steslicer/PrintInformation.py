...
class PrintInformation(QObject):
    ...
    def _calculateInformation(self, build_plate_number: int) -> None:
        ...
        material_preference_values = json.loads(self._application.getInstance().getPreferences().getValue("steslicer/material_settings"))
        ...
        for position in extruder_stacks:
            ...
            if material_guid in material_preference_values:
                ...
                if material_values and "spool_weight" in material_values:
                    ...
                    if extruder_stack.getMetaDataEntry("properties", {}).get("weight", 0) is not None:
    ...
    def _onPreferencesChanged(self, preference: str) -> None:
        if preference != "steslicer/material_settings":
            return
    ...
    def _updateJobName(self) -> None:
        ...
        if not self._is_user_specified_job_name:
            ...
            elif self._application.getInstance().getPreferences().getValue("steslicer/jobname_prefix"):
