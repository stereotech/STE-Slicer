...
class MaterialManager(QObject):
    ...
    def initialize(self) -> None:
        ...
        favorites = self._application.getPreferences().getValue("steslicer/favorite_materials")
    ...
    def addFavorite(self, root_material_id: str) -> None:
        ...
        # Ensure all settings are saved.
        self._application.getPreferences().setValue("steslicer/favorite_materials", ";".join(list(self._favorites)))
        self._application.saveSettings()
