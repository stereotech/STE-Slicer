...
class AutoSave:
    def __init__(self, application):
        ...
        self._application.getPreferences().addPreference("steslicer/autosave_delay", 1000 * 10)

        self._change_timer = QTimer()
        self._change_timer.setInterval(self._application.getPreferences().getValue("steslicer/autosave_delay"))
