...
class CrashHandler:
    ...
    def __init__(self, exception_type, value, tb, has_started = True):
        ...
        # If STE Slicer has fully started, we only show fatal errors.
        # If STE Slicer has not fully started yet, we always show the early crash dialog. Otherwise, STE Slicer will just crash
    ...
    def _exceptionInfoWidget(self):
        ...
        split_path = []
        folder_name = ""
        # Split until reach folder "steslicer"
        while folder_name != "steslicer":
    ...
    def _logInfoWidget(self):
        ...
        text_area = QTextEdit()
        tmp_file_fd, tmp_file_path = tempfile.mkstemp(prefix = "steslicer-crash", text = True)
