...
from steslicer.OAuth2.AuthorizationRequestServer import AuthorizationRequestServer
from steslicer.OAuth2.AuthorizationRequestHandler import AuthorizationRequestHandler

if TYPE_CHECKING:
    from steslicer.OAuth2.Models import AuthenticationResponse
