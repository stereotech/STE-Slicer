...
import steslicer.SteSlicerApplication #To get the build plate.
from steslicer.Settings.ExtruderStack import ExtruderStack #For typing.
from steslicer.Settings.SettingOverrideDecorator import SettingOverrideDecorator #For per-object settings.
...
class SteSlicerSceneNode(SceneNode):
    ...
    def isVisible(self) -> bool:
        return super().isVisible() and self.callDecoration("getBuildPlateNumber") == steslicer.SteSlicerApplication.SteSlicerApplication.getInstance().getMultiBuildPlateModel().activeBuildPlate

    def isSelectable(self) -> bool:
        return super().isSelectable() and self.callDecoration("getBuildPlateNumber") == steslicer.SteSlicerApplication.SteSlicerApplication.getInstance().getMultiBuildPlateModel().activeBuildPlate
