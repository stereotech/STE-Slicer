...
import steslicer.CuraApplication #To get the build plate.
...
class CuraSceneNode(SceneNode):
    ...
    def isVisible(self) -> bool:
        return super().isVisible() and self.callDecoration("getBuildPlateNumber") == steslicer.CuraApplication.CuraApplication.getInstance().getMultiBuildPlateModel().activeBuildPlate

    def isSelectable(self) -> bool:
        return super().isSelectable() and self.callDecoration("getBuildPlateNumber") == steslicer.CuraApplication.CuraApplication.getInstance().getMultiBuildPlateModel().activeBuildPlate
